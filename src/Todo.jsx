...
const Todo = props => {
  ...
  var tag2;
  if (props.complete) {
    tag1 = <del>{"    " + props.description}</del>;
    tag2 = <del>{"Due on " + props.dueDate}</del>;
  } else {
    tag1 = <strong>{"    " + props.description}</strong>;
    tag2 = <strong>{"Due on " + props.dueDate}</strong>;
  }
  ...
  return (
    <div>
      ...
      <li key={props.id} className={props.priority + props.hideTodo}>
        <label>
          <input
        ...
        <div className="pull-right">
          {tag2}
          <a id="edit-link" href="#" onClick={props.handleEditing}>
            <i className="glyphicon glyphicon-edit edit-todo" />
          </a>
