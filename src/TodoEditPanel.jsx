...
const TodoEditPanel = props => {
    ...
    <li  className={props.priority}>
        ...
        <textarea onChange={props.handleDescriptionEdits} type='text' value={props.description} className='form-control update-todo-text'/>
        ...
        <div className='row'>
            ...
            <div className='col-md-6'>
                ...
                <select onChange={props.handlePriorityEdits} className='form-control update-todo-priority ' value={props.priority}>
